...
export default function TypeOperationEdit() {
  ...
  return (
    <Page>
      <TitlePages linkBack="/type-operation" icon={faPenToSquare}>
      ...
      <div className="flex flex-col gap-8 p-5 w-full">
        <div className="flex flex-col gap-5">
          ...
          <Input
            ...
            size="extra-large"
            value={idSystemTypeOperation}
            onChange={(e) => setIdSystemTypeOperation(e.target.value)}
            icon={faReceipt}
          />
        </div>
        <div className="flex flex-col gap-5">
          ...
          <Input
            ...
            onChange={(e) => setNameTypeOperation(e.target.value)}
            icon={faLandmark}
          />
        </div>
        <div className="flex flex-col gap-5">
