...
export default function TypeSupplyEdit() {
  ...
  return (
    <Page>
      <TitlePages linkBack="/type-supply" icon={faAdd} >Editar Tipo de Pedido</TitlePages>
      <div className="flex flex-col gap-8 p-5 w-full">
        ...
        <div className="flex flex-col gap-5" >
          <Button color="#2E8B57" onClick={editTypeSupply} size="meddium" textColor="white" secondaryColor="#81C784">Editar</Button>
        </div>
        {error &&
          <div>
