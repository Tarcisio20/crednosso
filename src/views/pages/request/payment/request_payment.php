...
<div>
    ...
    <div class="box-buttons">
        <a class="btn btn-success" href="<?php echo $base; ?>/request/payment/add">
                ...
                <tbody class="table-group-divider">
                    <?php foreach($payments as $payment): ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="<?php echo $base; ?>/request/payment/edit/<?php echo $payment['id_shipping']; ?>">
