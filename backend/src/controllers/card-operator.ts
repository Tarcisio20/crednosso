...
import { addCardOperator, getCardOperatorForId, getForIdTreasury, updateCardOperator } from "../services/cardOperator"
...
export const update : RequestHandler = async (req, res) => {
    ...
    const updateCOperator = await updateCardOperator(parseInt(cardOperatorId), safeData.data)
    if(!updateCOperator){
