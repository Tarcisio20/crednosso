...
import { addTypeSupply, getAllTypeSupply, getTypeSupplyForId, updateTypeSupply } from "../services/typeSupply"
...
export const update : RequestHandler = async (req, res) => {
    ...
    const updateType = await updateTypeSupply(parseInt(typeSupplyId), safeData.data)
    if(!updateType){
